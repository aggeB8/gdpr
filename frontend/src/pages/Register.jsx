...
export default function Register() {
  ...
  // Skicka formulär med reCaptcha - TESTVERSION (byt tillbaka senare)
  const handleSubmit = async (e) => {
    ...
    // Kontrollera att reCaptcha är laddat.
    if (!executeRecaptcha) {
    ...
    try {
      ...
      console.log("Token (first 30 chars):", recaptchaToken?.substring(0, 30));
      ...
      if (err.response) {
        setError(
          err.response.data.message || "Något gick fel vid registrering."
        );
      } else {
        ...
        <div className="w-full max-w-lg bg-white p-10 rounded-3xl shadow-2xl border border-slate-100 flex flex-col items-center">
          <div className="flex flex-col items-center mb-8">
            <div className="bg-violet-100 rounded-full w-16 h-16 flex items-center justify-center mb-4">
              ...
              >
                <path
                  ...
                  d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.5 19.25v-1.5A2.25 2.25 0 016.75 15.5h10.5a2.25 2.25 0 012.25 2.25v1.5M18 19.25a2.25 2.25 0 002.25-2.25V17a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 17v.25A2.25 2.25 0 006 19.25"
                />
              </svg>
            </div>
            ...
            <p className="text-slate-600 text-base">
              Skapa ditt konto och börja yappa direkt
            </p>
          </div>
