...
export default function YapCard({ yap, onDelete, onReplyClick }) {
    ...
    const handleLike = async () => {
        try {
            await axiosClient.put(`/yaps/${yap._id}/like`, {
                userId: user.userId
            })
    ...
    return (
        <div className="border-b border-slate-700 p-4 transition-all duration-200 relative hover:bg-slate-700/50 group">
            <button
            ...
            <div className="flex space-x-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-1">
                        ...
                        <span className="text-sm text-slate-500">{yap.timeAgo}</span>
                    </div>

                    <p className="leading-relaxed mb-3 text-slate-300">{yap.text}</p>
                    ...
                    <div className="flex items-center justify-between max-w-md text-slate-500">
                        ...
                        <button className="flex items-center space-x-2 hover:text-green-400 transition-all duration-200 p-2 rounded-full hover:bg-green-500/10 group/btn">
                            <div className="relative">
                                <svg
                                    className="w-5 h-5 group-hover/btn:scale-110 transition-transform duration-200"
                                    fill="none"
